...
<tr>
	<td width="25%" valign="top">
		...
		<tr align="center">
			<td><input type="text" id="tota" name="tota" value="<%=tot%>"/></td>
		</tr>
		<tr align="center" class="Estilo8">
			<td><%if marka=0 and sindatos=1 then %><input name="STK" type="button" class="Estilo8" id="STK" onClick="cargar()" value="CARGAR STOCK" />
				<%else %>
				<%if marka= 1 then %>Docuemnto esta registrado<br /> en tienda - <%=tendero%><% end if %>
				<%end if %>
			</td>
		</tr>
		</table>
