...
var auto=0;
var url = '../DESCUENTOS.asp?'
var alias = 'DESCUENTOS'
var TBL = 'DESCUENTOS'
var PK  = 'codigo'
var DS  = 'DESCRIPCION'
...
// **************************************************************
var funcionalidad = 'comun/INSERdes.asp?'
            ...
            <table	align="center" width="100%" cellpadding="1" cellspacing="0"  bgcolor="WHITE" border="1" >
              <tr valign="middle"> 
                ...
                <td bgcolor="WHITE"  valign="middle"> 
                  <input type="text" id="COD" name="COD" class="DATOSGRANDE" tabindex="-1" readonly="readonly" size="2"/>
                </td>
                <td bgcolor="<%=(Application("borde"))%>" align="right" class="Estilo8">DESCRIPCION :&nbsp;</td>
                <td bgcolor="#FFFFFF" > 
                  <input type="text" id="DES" name="DES"  size="50" />
                </td>
                <td  bgcolor="<%=(Application("borde"))%>" align="right" class="Estilo8">&nbsp;% :&nbsp;</td>
                <td bgcolor="#FFFFFF" > 
                  <input type="text" id="DCT" name="DCT"  size="5" onkeyup="this.value = toInt(this.value)" />
                </td>
              </tr>
            </table>
         </td>   
...
function llena(pos) {
    var t = document.all.TABLA;
    thisForm.DCT.value = ltrim(t.rows(pos).cells(2).innerText);
    return true
}
...
function VALIDA() {
    ...
    if (trim(window.thisForm.DCT.value) == "") {
        alert('Debe Informar el porcentaje del descuento');
