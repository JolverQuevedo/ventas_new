...
var auto=0;
var url = '../temporadas.asp?'
var alias = 'temporadas'
var TBL = 'TEMPORADAS'
var PK  = 'codigo'
var DS  = 'DESCRIPCION'
...
<form name="thisForm" id="thisForm" method="post" action="TEMPORADAS.asp">
   		...
   		<td>
            ...
            cellpadding="1" cellspacing="0"  bgcolor="WHITE" border="1" >
              <tr valign="middle"> 
                ...
                <td bgcolor="#FFFFFF" colspan="5" width="50%"> 
