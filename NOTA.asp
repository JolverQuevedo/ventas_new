...
CAD=    " SELECT distinct M1.CLIENTE, C1.NOMBRE, C1.DIRECCION, M2.CODART, M1.FECDOC, " & _
        ...
        " LTRIM(RTRIM(isnull(M2.TEXTO,''))) AS DESCRI,   m2.item,                   " & _ 
	...
	<table border="0"   align="left" cellpadding="0"cellspacing="0" WIDTH="700px">
		<%do while not rs.eof %>
            <tr  valign="bottom">
                ...
                <td width="430px" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <%=left(trim(RS("DESCRI")),65) %></td>
                <td width="50px" align="right"><%=formatnumber(RS("PORDES"),2,,true)%>%</td>
				<td width="80px" align="right"><%=formatnumber(RS("PVT"),2,,true) %>&nbsp;&nbsp;&nbsp;&nbsp;</td>
