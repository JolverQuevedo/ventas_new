...
CAD =	" select DISTINCT CODIGO, DESCRI, PLANILLA AS PLA " & _
...
<table width="100%">
	<tr><td  align="center" class="estilo6">Artículos Plantilla -->Todas las tiendas</td></tr>
	<tr><td><hr /></td></tr>
</table>
...
function graba(cod, ff,op) {
    ...
    cad  = "comun/updateplantillaTOT.asp?lin=" + pos + '&cod=' + trim(cod)
    cad += '&pla=' + op
